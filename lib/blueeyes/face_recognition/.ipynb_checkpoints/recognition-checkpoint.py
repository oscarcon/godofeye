...
def preprocess_image(self, img, norm=False):
    ...
    if norm:
        ...
        black = np.expand_dims(balck, axis=0)
    return black
            ...
            with tqdm(total=len(img_paths)) as pbar:
                for img_path in img_paths:
                    try:
                        ...
                        features.append((encoded_vec, id))
                        pbar.update(1)
                    except Exception as e:
                        print(e)
        return features
